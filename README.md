...
- If youre not familiar with the W83C42, i added a schematic schowing the basic setup of how to connect it up to an Arduino Nano (or any arduino), you can also check out the [schematic](https://theretroweb.com/chip/documentation/w83c42-6754b67123cf0399527016.pdf).
